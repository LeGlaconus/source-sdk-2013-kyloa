...
LINK_ENTITY_TO_CLASS(weapon_spas12, CWeaponSpas12);
PRECACHE_WEAPON_REGISTER(weapon_spas12);
...
acttable_t* GetSpas12Acttable()
{
	return CWeaponSpas12::m_acttable;
}

int GetSpas12ActtableCount()
{
	return ARRAYSIZE(CWeaponSpas12::m_acttable);
}
#endif
...
//
//-----------------------------------------------------------------------------
void CWeaponSpas12::SecondaryAttack(void)
{
	// Only the player fires this way so we can cast
	CBasePlayer* pPlayer = ToBasePlayer(GetOwner());
...
//==================================================
/*
void CWeaponSpas12::WeaponIdle( void )
{
	//Only the player fires this way so we can cast
